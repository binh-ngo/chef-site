...
export const Blur = () => {
  return (
    ...
    <div className='relative w-full max-w-lg'>
      ...
      <div className='absolute -bottom-8 left-20 w-72 h-72 bg-yellow-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000'>
      </div> 
      </div>
      </div> 
      )
